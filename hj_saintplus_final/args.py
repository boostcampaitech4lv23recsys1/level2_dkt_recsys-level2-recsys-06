...
def parse_args():
    ...
    parser.add_argument(
        "--model_name", default=name+"_model.pt", type=str, help="model file name"
    )
    ...
    # 모델
    parser.add_argument(
        "--hidden_dim", default=120, type=int, help="hidden dimension size"
    )
    ...
    ### 중요 ###
    parser.add_argument("--model", default="saintplus", type=str, help="model type")
